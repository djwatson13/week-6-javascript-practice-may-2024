...
function day2Part3() {
  ...
  alert("Try it!");
  // Try it!
  // TODO: Prompt the user for how much is in their wallet. Convert it to a number, and tell them true or false if they can buy a TV.
  ...
  // 3. use a math expression with the > operator to say if the statements is true or false.
  messageParagraph.innerHTML = `The TV costs ${tvNumber}. You have ${walletNumber} in your wallet. You can afford the TV: ${walletNumber > tvNumber}`
...
function day2Part4() {
  ...
  alert("Try it!");
  // Try it!
  // TODO: Prompt the user for how much is in their bank account. Convert it to a number, and tell them true or false if they can buy a rocket.
  // 1. Ask the user for data
  ...
  // 3. use a math expression with the > operator to say if the statements is true or false.
  messageParagraph.innerHTML = `The rocket costs ${rocketNumber}. You have ${bankNumber} in your bank account. You can afford the rocket. ${bankNumber > rocketNumber}`
